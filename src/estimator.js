...
const covid19ImpactEstimator = (data) => {
  ...
  impact.hospitalBedsByRequestedTime = Math.round(numberOfBeds - impact.severeCasesByRequestedTime);
  severeImpact.hospitalBedsByRequestedTime = Math.round(numberOfBeds
