...
const covid19ImpactEstimator = (data) => {
  ...
  impact.hospitalBedsByRequestedTime = Math.floor(numberOfBeds - impact.severeCasesByRequestedTime);
  severeImpact.hospitalBedsByRequestedTime = Math.floor(numberOfBeds
